...
const OrganizationDisplay = ({ organization }) => {
    ...
    // const addUserToPlane = async (planId) => {
    ...
    //     } catch (error) {
    //         console.error("Error adding user to plan:", error.response?.data || error.message);
    //         alert("Failed to add user to plan. Please try again.");
    //     } finally {
    //         setLoading(false);
    //     }
    // }
                                        ...
                                        <div className=" w-[75%]">
                                            <div className="flex justify-evenly items-center p-2">
                                                {org.planId.map((plan) => (
                                                    ...
                                                    <div
                                                        key={plan._id}
                                                        className={`${plan.name === "Plus Plan" ? "bg-yellow-300" : (plan.name === 'Basic Plan' ? "bg-orange-700" : "bg-orange-400")} shadow rounded-lg p-4 leading-2 max-w-[250px] min-w-[250px] min-h-[350px] max-h-[400px] flex flex-col justify-evenly`}
                                                    >
